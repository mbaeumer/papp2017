        ...
        this.modes = [
            {
                ...
                getVisibleDates: function (date, selected) {
                    ...
                    for (var i = 0; i < numDates; i++) {
                        ...
                        days[i] = makeDate(dt, format.day, (selected && selected.getDate() === dt.getDate() &&
                                                            selected.getMonth() === dt.getMonth() &&
                                                            selected.getFullYear() ===
                                                            dt.getFullYear()), dt.getMonth() !== month);
                    }
                    for (var j = 0; j < 7; j++) {
            ...
            },
            {
                ...
                getVisibleDates: function (date, selected) {
                    ...
                    for (var i = 0; i < 12; i++) {
                        ...
                        months[i] = makeDate(dt, format.month, (selected && selected.getMonth() === i &&
            ...
            },
            {
                name: 'year',
                getVisibleDates: function (date, selected) {
                    var years = new Array(yearRange), year = date.getFullYear(), startYear = parseInt((year - 1) /
                                                                                                      yearRange, 10) *
                                                                                             yearRange + 1;
        ...
        return {
            ...
            link: function (scope, element, attrs, ctrls) {
                ...
                scope.getWeekNumber = function (row) {
                    return ( mode === 0 && scope.showWeekNumbers &&
                             row.length === 7 ) ? getISO8601WeekNumber(row[0].date) : null;
                };
                ...
                scope.$watch('numPages + currentPage + maxSize', function () {
                    ...
                    if (isMaxSized) {
                        if (rotate) {
                            ...
                            startPage = ((Math.ceil(paginationCtrl.currentPage / scope.maxSize) - 1) * scope.maxSize) +
                                        1;
                    ...
                    if (directionLinks) {
                        var previousPage = makePage(paginationCtrl.currentPage -
                                                    1, previousText, false, paginationCtrl.noPrevious());
                        scope.pages.unshift(previousPage);

                        var nextPage = makePage(paginationCtrl.currentPage +
                                                1, nextText, false, paginationCtrl.noNext());
        ...
        return {
            ...
            link: function (scope, element, attrs, paginationCtrl) {
                ...
                scope.$watch('numPages + currentPage', function () {
                    ...
                    // Add previous & next links
                    var previousPage = makePage(paginationCtrl.currentPage -
                                                1, previousText, paginationCtrl.noPrevious(), true, false);
                    scope.pages.unshift(previousPage);

                    var nextPage = makePage(paginationCtrl.currentPage +
                                            1, nextText, paginationCtrl.noNext(), false, true);
                    scope.pages.push(nextPage);
                });
            }
        };
...
angular.module('ui.bootstrap.progressbar', ['ui.bootstrap.transition'])
    ...
    .controller('ProgressBarController', ['$scope', '$attrs', 'progressConfig', function ($scope, $attrs, progressConfig) {
        ...
        var stackedTypes = angular.isDefined($attrs.stackedTypes) ? $scope.$eval('[' + $attrs.stackedTypes +
        ...
        this.makeBar = function (newBar, oldBar, index) {
            ...
            var type = (angular.isObject(newBar) &&
                        angular.isDefined(newBar.type)) ? newBar.type : (autoType) ? getStackedType(index || 0) : null;
        ...
        return {
            ...
            link: function (scope, element, attrs, ngModelCtrl) {
                ...
                function refreshTemplate() {
                    ...
                    scope.meridian = ( scope.showMeridian ) ? (( selected.getHours() <
                                                                 12 ) ? meridians[0] : meridians[1]) : '';
